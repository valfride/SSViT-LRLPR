...
| OTE | CVPR 2024 | [Paper](https://openaccess.thecvf.com/content/CVPR2024/html/Xu_OTE_Exploring_Accurate_Scene_Text_Recognition_Using_One_Token_CVPR_2024_paper.html) | [Xu-Jianjun/OTE](https://github.com/Xu-Jianjun/OTE) | `baselines_configs/OTE_BASELINE.yaml` | `OTE_BASELINE` | `OTE` |
| LISTER | ICCV 2023 | [Paper](https://openaccess.thecvf.com/content/ICCV2023/html/Cheng_LISTER_Neighbor_Decoding_for_Length-Insensitive_Scene_Text_Recognition_ICCV_2023_paper.html) | — | `baselines_configs/LISTER_BASELINE.yaml` | `LISTER_BASELINE` | `LISTER_INTERNAL` |
...
| CPPD | TPAMI 2025 | [Paper](https://doi.org/10.1109/TPAMI.2025.3545453) | [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) | `baselines_configs/CPPD_BASELINE.yaml` | `CPPD_BASELINE` | `CPPD` |
